...
customer_args.add_argument('user_id', type=str, required=False, location='args', help='List Customers by User ID')
...
customer_args.add_argument('active', type=str, required=False, location='args', help='List Customers by active')
